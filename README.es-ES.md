...
Extensión de PHP que implementa los bindings de la [biblioteca H3](https://github.com/uber/h3) en estilo POO
...
Todo el contenido de este paquete está licenciado bajo la [licencia MIT].
